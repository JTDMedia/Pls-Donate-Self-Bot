...
_G.Text = [[<stroke color="#2A0030" thickness="5"><font size="25"><font color= "#445094"><font face="Bangers">Please donate, Anything Helps!</font></font></font></stroke>
Status: AFK
...
_G.thanksText = "Thanks for donating %s <3" -- %s is the amount of robux they donated, the text to thank the person
_G.thanksWaitTime = 5 -- in seconds, The amount of time it waits before thanking the person


_G.beg = false -- Begs in the chat every time the begInterval has past
...
_G.onDonateLoadString = "game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.Head.CFrame;Instance.new("ParticleEmitter",{Parent=game.Players.LocalPlayer.Character.Head,Color=ColorSequence.new(Color3.fromRGB(255,0,0)),Lifetime=NumberRange.new(1),Rate=100,Speed=NumberRange.new(50)}):Emit(50)" -- runs this script when someone donates

-- DONT Change! (or do if yk what you're doing)
_G.loadstr = "https://raw.githubusercontent.com/JTDMedia/Pls-Donate-Self-Bot/main/source.lua"
